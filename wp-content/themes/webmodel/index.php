        ...
        <div class="Header-Inner">
            <div class="Header-Content">
                ...
                <ul class="Header-List">
                    <li class="Header-Item">свободный график</li>
                    <li class="Header-Item">ежедневные выплаты</li>
                    <li class="Header-Item">персональное обучение</li>
                </ul>
    ...
    <div class="Container">
        ...
        <div class="Steps-List">
            <div class="Steps-ImgBg">
                <svg width="1760" height="351" viewBox="0 0 1760 351" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <path class="Animation" d="M-16 92.9811C223.099 19.738 644 -38 897.062 33.0243C1043.32 74.0734 1232.5 -13.5 1436.95 33.0243C1577.85 65.0886 1664.83 22.7359 1727.03 82.193C1768.81 122.137 1767.81 193.409 1734.67 249.868C1708.16 295.036 1588.27 310.461 1477 327.5C1444.37 332.496 1352.69 342.693 1265 327.5C1156.92 308.773 1046.94 327.5 1119.5 349.108L1046.94 350" stroke="#4A4A4A" stroke-dasharray="10 10"/>
                    <rect x="1181.17" y="335.583" width="38.3405" height="38.3405" transform="rotate(168.592 1181.17 335.583)" fill="url(#pattern0)" fill-opacity="0.7"/>
                    <defs>
            ...
            <div class="Steps-Item">
                ...
                <div class="Steps-Text">Заполнение анкеты</div>
            </div>
            <div class="Steps-Item">
                <img src="images/docs.png" alt="icon" class="Steps-Img">
                <div class="Steps-Text">Проверка документов</div>
            </div>
            <div class="Steps-Item">
                <img src="images/education.png" alt="icon" class="Steps-Img">
                <div class="Steps-Text">Обучение</div>
            </div>
            <div class="Steps-Item">
                <img src="images/star.png" alt="icon" class="Steps-Img">
                <div class="Steps-Text">Начаинаем:)</div>
            </div>
        </div>
